...
public class ResultPageActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            AppnextWebView.u(this).a(str, (AppnextWebView.c) new AppnextWebView.c() {
    ...
    public class b {
        ...
        public final void adClicked(String str, int i) {
            ...
            AppnextAd unused = resultPageActivity.aE = (AppnextAd) resultPageActivity.parseAd(str);
            q g = ResultPageActivity.this.userAction;
            AppnextAd b = ResultPageActivity.this.aE;
            StringBuilder sb = new StringBuilder();
            ...
            sb.append("1");
            g.a(b, sb.toString(), ResultPageActivity.this.placementID, new e.a() {
                public final void error(String str) {
                }
        ...
        public final void postView(String str) {
            ...
            q g = ResultPageActivity.this.userAction;
            g.a(appnextAd, ResultPageActivity.this.h(appnextAd).getImpressionURL() + "&tem_id=" + ResultPageActivity.this.id + "1", (e.a) null);
        }
                ...
                public final void run() {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            ...
                            ResultPageActivity resultPageActivity2 = ResultPageActivity.this;
                            resultPageActivity2.loadJS("Appnext.load(" + ResultPageActivity.this.h(ResultPageActivity.this.ic).getAdJSON() + "," + ResultPageActivity.this.ca + "," + ResultPageActivity.this.fJ + ");");
                        }
                    });
                }
            }).start();
    ...
    public void onDestroy() {
        /*
            r1 = this;
            super.onDestroy()
            android.webkit.WebView r0 = r1.webView     // Catch:{ all -> 0x000f }
            if (r0 == 0) goto L_0x000f
            android.webkit.WebView r0 = r1.webView     // Catch:{ all -> 0x000f }
            r0.destroy()     // Catch:{ all -> 0x000f }
            r0 = 0
            r1.webView = r0     // Catch:{ all -> 0x000f }
        L_0x000f:
            com.appnext.core.q r0 = r1.userAction     // Catch:{ all -> 0x0014 }
            r0.destroy()     // Catch:{ all -> 0x0014 }
        L_0x0014:
            return
        */
