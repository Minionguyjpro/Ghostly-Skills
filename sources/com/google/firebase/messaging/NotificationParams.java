...
public class NotificationParams {
    ...
    public NotificationParams(Bundle bundle) {
        ...
        throw new NullPointerException(c.DATA);
    }
    ...
    public String getLocalizationResourceForKey(String str) {
        ...
        return getString("_loc_key".length() != 0 ? valueOf.concat("_loc_key") : new String(valueOf));
    }

    public Object[] getLocalizationArgsForKey(String str) {
        String valueOf = String.valueOf(str);
        JSONArray jSONArray = getJSONArray("_loc_args".length() != 0 ? valueOf.concat("_loc_args") : new String(valueOf));
        if (jSONArray == null) {
            return null;
        }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            ...
            String userFriendlyKey = userFriendlyKey("_loc_key".length() != 0 ? valueOf.concat("_loc_key") : new String(valueOf));
