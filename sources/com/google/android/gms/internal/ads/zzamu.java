...
public final class zzamu {
    ...
    public final void zza(ViewGroup viewGroup, zzjn zzjn, String str) {
        zza(viewGroup, zzjn, str, (int) DrawableConstants.CtaButton.BACKGROUND_COLOR, -1);
    }

    public final void zza(ViewGroup viewGroup, zzjn zzjn, String str, String str2) {
        zzane.zzdk(str2);
        zza(viewGroup, zzjn, str, -65536, (int) DrawableConstants.CtaButton.BACKGROUND_COLOR);
    }
}
