...
public abstract class OSChannelTracker {
    ...
    public JSONArray getLastReceivedIds() {
        ...
        try {
            ...
            for (int i = 0; i < lastChannelObjects.length(); i++) {
                ...
                if (currentTimeMillis - jSONObject.getLong(d.fl) <= indirectAttributionWindow) {
    ...
    public void saveLastId(String str) {
        ...
        if (str != null && !str.isEmpty()) {
            ...
            try {
                lastChannelObjectsReceivedByNewId.put(new JSONObject().put(getIdTag(), str).put(d.fl, System.currentTimeMillis()));
