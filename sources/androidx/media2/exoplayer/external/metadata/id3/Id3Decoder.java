...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static androidx.media2.exoplayer.external.metadata.id3.Id3Frame decodeFrame(int r19, androidx.media2.exoplayer.external.util.ParsableByteArray r20, boolean r21, int r22, androidx.media2.exoplayer.external.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x0067:
            ...
            androidx.media2.exoplayer.external.util.Log.w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x01f2:
            ...
            androidx.media2.exoplayer.external.util.Log.w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
        L_0x021e:
            r7.setPosition(r14)
            return r1
        L_0x0222:
            java.lang.String r0 = "Unsupported character encoding"
            androidx.media2.exoplayer.external.util.Log.w(r12, r0)     // Catch:{ all -> 0x012e }
            r7.setPosition(r14)
            return r16
        L_0x022b:
            r7.setPosition(r14)
        ...
        L_0x022f:
            ...
            androidx.media2.exoplayer.external.util.Log.w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
