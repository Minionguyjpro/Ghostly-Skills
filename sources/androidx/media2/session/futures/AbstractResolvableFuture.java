...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v5, resolved type: androidx.media2.session.futures.AbstractResolvableFuture$SafeAtomicHelper} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v8, resolved type: androidx.media2.session.futures.AbstractResolvableFuture$SynchronizedHelper} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v9, resolved type: androidx.media2.session.futures.AbstractResolvableFuture$SafeAtomicHelper} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v8, resolved type: androidx.media2.session.futures.AbstractResolvableFuture$SafeAtomicHelper} */
    /* JADX WARNING: Multi-variable type inference failed */
    static {
        /*
            java.lang.Class<androidx.media2.session.futures.AbstractResolvableFuture> r0 = androidx.media2.session.futures.AbstractResolvableFuture.class
            ...
            log = r1
            androidx.media2.session.futures.AbstractResolvableFuture$SafeAtomicHelper r1 = new androidx.media2.session.futures.AbstractResolvableFuture$SafeAtomicHelper     // Catch:{ all -> 0x004e }
            java.lang.Class<androidx.media2.session.futures.AbstractResolvableFuture$Waiter> r2 = androidx.media2.session.futures.AbstractResolvableFuture.Waiter.class
            ...
            java.lang.Class<androidx.media2.session.futures.AbstractResolvableFuture$Waiter> r2 = androidx.media2.session.futures.AbstractResolvableFuture.Waiter.class
            java.lang.Class<androidx.media2.session.futures.AbstractResolvableFuture$Waiter> r4 = androidx.media2.session.futures.AbstractResolvableFuture.Waiter.class
            ...
            java.lang.Class<androidx.media2.session.futures.AbstractResolvableFuture$Listener> r2 = androidx.media2.session.futures.AbstractResolvableFuture.Listener.class
        ...
        L_0x004e:
            r0 = move-exception
            androidx.media2.session.futures.AbstractResolvableFuture$SynchronizedHelper r1 = new androidx.media2.session.futures.AbstractResolvableFuture$SynchronizedHelper
            r1.<init>()
        L_0x0054:
            ATOMIC_HELPER = r1
        ...
        L_0x0063:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.session.futures.AbstractResolvableFuture.<clinit>():void");
    }
    ...
    public final boolean cancel(boolean r8) {
        ...
        L_0x0008:
            r3 = 0
        L_0x0009:
            boolean r4 = r0 instanceof androidx.media2.session.futures.AbstractResolvableFuture.SetFuture
            r3 = r3 | r4
            if (r3 == 0) goto L_0x0061
            boolean r3 = GENERATE_CANCELLATION_CAUSES
            if (r3 == 0) goto L_0x001f
            androidx.media2.session.futures.AbstractResolvableFuture$Cancellation r3 = new androidx.media2.session.futures.AbstractResolvableFuture$Cancellation
        ...
        L_0x001f:
            ...
            androidx.media2.session.futures.AbstractResolvableFuture$Cancellation r3 = androidx.media2.session.futures.AbstractResolvableFuture.Cancellation.CAUSELESS_INTERRUPTED
            goto L_0x0026
        L_0x0024:
            androidx.media2.session.futures.AbstractResolvableFuture$Cancellation r3 = androidx.media2.session.futures.AbstractResolvableFuture.Cancellation.CAUSELESS_CANCELLED
        L_0x0026:
            r5 = 0
            r4 = r7
        L_0x0028:
            androidx.media2.session.futures.AbstractResolvableFuture$AtomicHelper r6 = ATOMIC_HELPER
        ...
        L_0x0035:
            ...
            androidx.media2.session.futures.AbstractResolvableFuture$SetFuture r0 = (androidx.media2.session.futures.AbstractResolvableFuture.SetFuture) r0
            com.google.common.util.concurrent.ListenableFuture<? extends V> r0 = r0.future
            boolean r4 = r0 instanceof androidx.media2.session.futures.AbstractResolvableFuture
            if (r4 == 0) goto L_0x0055
            r4 = r0
            androidx.media2.session.futures.AbstractResolvableFuture r4 = (androidx.media2.session.futures.AbstractResolvableFuture) r4
        ...
        L_0x004d:
            r5 = 0
        L_0x004e:
            boolean r6 = r0 instanceof androidx.media2.session.futures.AbstractResolvableFuture.SetFuture
            r5 = r5 | r6
        ...
        L_0x0062:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.session.futures.AbstractResolvableFuture.cancel(boolean):boolean");
    }
