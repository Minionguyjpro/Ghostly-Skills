...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        String str2 = str;
        ArrayList arrayList = new ArrayList();
        Uri build = new Uri.Builder().scheme(Constants.VAST_TRACKER_CONTENT).authority(str2).build();
        Uri build2 = new Uri.Builder().scheme(Constants.VAST_TRACKER_CONTENT).authority(str2).appendPath("file").build();
        Cursor cursor = null;
        try {
